		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group row">
					<label for="name" class="col-sm-2 col-form-label">Nama Prestasi</label>
					<div class="col-sm-8">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input type="text" name="content" id="content" value="<?= $input->content ?>" required class="form-control">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<?php if (!empty($input->photo)) : ?>
							<img src="<?= base_url("img/prestasi/$input->photo") ?>" alt="" height="150">
						<?php else : ?>
							<p>No Photo</p>
						<?php endif; ?>
						<br>
				...
				<div class="row mt-4">
					<div class="col-8 offset-2">
						<a href="<?= base_url('prestasi') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>Kembali</a>
