	...
	<div class="col-xl-12 col-lg-12">
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<h4 class="m-0 font-weight-bold text-success">Form Update Jurusan Asistem Keperawatan</h4>
			</div>
			<!-- Card Body -->
			<div class="card-body">
				<div class="row mb-4">
				...
				<div class="form-group row">
					<label for="asisten" class="col-sm-2 col-form-label">Asisten Keperawatan</label>
					<div class="col-sm-8">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<?php if (!empty($content->photo)) : ?>
							<img src="<?= base_url("img/asisten/$content->photo") ?>" alt="" height="150">
						<?php else : ?>
							<p>No Photo</p>
						<?php endif; ?>
						<br>
				...
				<div class="row mt-4">
					<div class="col-8 offset-2">
						<a href="<?= base_url('asisten') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>Kembali</a>
